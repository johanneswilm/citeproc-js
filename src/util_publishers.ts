...
CSL.PublisherOutput = function (this: any, state: CslState, group_tok: any): void {
    this.state = state;
    this.group_tok = group_tok;
    this.varlist = [];
};

CSL.PublisherOutput.prototype.render = function (this: any): void {
    this.clearVars();
    this.composeAndBlob();
...
CSL.PublisherOutput.prototype.clearVars = function (this: any): void {
